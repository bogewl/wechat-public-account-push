export const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wx2989250c23f255e9",
  
  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "6b7809346ba51d093ff9411f8d2bd83f",
  ...
  USERS: [
    {
      ...
      id: "o7nEj54_9GhKGbXAc4-bkoEYqZ7A",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "6FbXV98RMTzib_IrKYBsJjk-5J7b-7VGdv2-6QiRNOk",
      // 所在省份
      province: "广东",
      // 所在城市
      city: "深圳",
      ...
      festivals: [
        ...
        {"type": "*生日", "name": "刘逸", "year": "2002", "date": "10-29"},
      ],
